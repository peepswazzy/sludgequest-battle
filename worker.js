...
<button data-mode="quest">🗺️ <b>Quest Mode 2.0</b><small>Headworks → DRC Boss. Run da whole plant.</small></button>
...
const questStages=[
{stage:"HEADWORKS",icon:"🗑️",questions:[
{t:"Equipment",y:"quest",d:3,q:"Influent flow rises sharply and differential level across a mechanical screen is increasing. What should the operator verify FIRST?",a:["Increase downstream RAS immediately","Screen operation, screenings buildup, and upstream/downstream levels","Reduce disinfection dose","Increase digester mixing"],c:1},
{t:"Process Control",y:"quest",d:4,q:"A grit system shows normal influent flow but grit carryover is increasing. Which condition should be checked early?",a:["Final effluent residual","Secondary clarifier blanket only","Hydraulic conditions and grit-removal equipment performance","Digester gas production"],c:2},
{t:"Safety",y:"quest",d:5,q:"During wet weather one influent screen is unavailable and channel level continues to rise. What is the best FIRST response?",a:["Verify available screening capacity, flow path, bypass risk, and downstream loading","Ignore the level until the storm passes","Shut down all influent pumping","Increase WAS to create capacity"],c:0}]},
{stage:"PRIMARY TREATMENT",icon:"🌀",questions:[
{t:"Process Control",y:"quest",d:3,q:"Primary effluent TSS rises while the clarifier sludge blanket is higher than normal. What should be checked FIRST?",a:["Aeration DO only","Sludge withdrawal operation, blanket depth, and hydraulic loading","Disinfectant residual","RAS concentration"],c:1},
{t:"Math",y:"quest",d:4,q:"A primary clarifier receives a much higher peak flow and solids removal drops. Which explanation is most reasonable?",a:["Longer detention time","Lower surface overflow rate","Improved settling automatically","Reduced detention time and increased hydraulic loading"],c:3},
{t:"Process Control",y:"quest",d:5,q:"One primary clarifier must be removed from service during high flow. What should be evaluated before changing the flow split?",a:["Available clarifier capacity, hydraulic loading, sludge withdrawal, and downstream impact","Only digester temperature","Only disinfectant residual","Whether RAS can be stopped"],c:0}]},
{stage:"BIOLOGICAL TREATMENT",icon:"🦠",questions:[
{t:"Nitrification",y:"quest",d:3,q:"Aeration DO is acceptable, but effluent ammonia rises after wasting was increased significantly. What should be evaluated?",a:["Screen differential only","Disinfection contact time only","SRT and nitrifier inventory along with loading and temperature","Primary sludge pumping only"],c:2},
{t:"Activated Sludge",y:"quest",d:4,q:"MLSS remains stable, but settleability worsens and SVI rises over several days. What is the best next step?",a:["Immediately stop RAS","Review sludge age, filament indicators, loading, DO trends, and clarifier performance","Double disinfectant dose","Increase grit-removal air"],c:1},
{t:"Nitrification",y:"quest",d:5,q:"A step-feed system shows rising ammonia in the final pass while upstream DO appears adequate. What should be verified FIRST?",a:["Actual air distribution, loading split, alkalinity/pH, and available nitrifier mass","Only influent temperature","Only secondary effluent TSS","Digester volatile acids"],c:0}]},
{stage:"SECONDARY CLARIFIERS",icon:"🌊",questions:[
{t:"Clarifiers",y:"quest",d:3,q:"Secondary blanket depth rises while RAS flow indication remains at target. What should be verified before increasing the setpoint?",a:["Actual RAS flow and pump/valve condition","Influent screen speed","Digester gas pressure","Disinfectant residual"],c:0},
{t:"Clarifiers",y:"quest",d:4,q:"Settleometer sludge settles well initially but floats several hours later. Which process is most likely contributing?",a:["Grit accumulation","Denitrification and nitrogen gas formation","Excess screening","High disinfectant intensity"],c:1},
{t:"Clarifiers",y:"quest",d:5,q:"Effluent TSS rises, blanket depth is increasing, and RAS concentration is unusually low. What is the best FIRST response?",a:["Double WAS immediately","Stop aeration","Verify clarifier/RAS hydraulics, actual return flow, settleability, and solids inventory","Increase disinfection"],c:2}]},
{stage:"DISINFECTION",icon:"🧪",questions:[
{t:"Disinfection",y:"quest",d:3,q:"Effluent disinfectant residual falls even though the feed setting has not changed. What should be checked FIRST?",a:["Chemical feed delivery, actual flow, demand, and analyzer/sample validity","RAS blanket only","Digester mixing","Screen spacing"],c:0},
{t:"Disinfection",y:"quest",d:4,q:"Plant flow increases while disinfectant feed remains fixed. What operational concern should be evaluated?",a:["Higher SRT automatically","Lower grit production","Dose and contact conditions may no longer be adequate","Improved pump efficiency"],c:2},
{t:"Disinfection",y:"quest",d:5,q:"A compliance-related disinfection reading suddenly becomes abnormal during a process upset. What is the best FIRST approach?",a:["Reset the analyzer and assume it is bad","Verify the reading and actual process conditions while protecting compliance and checking feed/contact performance","Change wasting immediately","Shut off influent pumps"],c:1}]},
{stage:"SOLIDS & DIGESTION",icon:"💩",questions:[
{t:"Digestion",y:"quest",d:3,q:"Digester volatile acids increase while alkalinity begins falling. What does this trend suggest?",a:["The digester may be moving toward instability","Nitrification is improving","Screening efficiency increased","Clarifier overflow rate fell"],c:0},
{t:"Digestion",y:"quest",d:4,q:"An anaerobic digester receives a sudden increase in organic loading. Which trend deserves close attention?",a:["Disinfection intensity","Screen differential only","Primary effluent residual","VA/alkalinity relationship, pH, gas production, and mixing"],c:3},
{t:"Digestion",y:"quest",d:5,q:"Digester mixing capacity is reduced while feed remains unchanged. What is the strongest operational concern?",a:["Effective treatment volume/contact may decrease, increasing localized loading and instability risk","Effluent disinfection automatically improves","Grit removal doubles","RAS concentration must decrease"],c:0}]},
{stage:"PROCESS CONTROL",icon:"📈",questions:[
{t:"Process Control",y:"quest",d:4,q:"Several indicators move outside normal ranges after a major hydraulic change. What should the operator do FIRST?",a:["Change every setpoint at once","Verify data and identify the limiting process before controlled adjustments","Wait until the next shift","Reset all alarms"],c:1},
{t:"Process Control",y:"quest",d:5,q:"Effluent ammonia is rising, clarifier blanket is climbing, and influent loading increased. Which approach gives the best troubleshooting picture?",a:["Evaluate only DO","Evaluate only RAS","Evaluate loading, SRT, aeration, settleability, RAS/blanket behavior, and trends together","Increase chemical dose without verification"],c:2},
{t:"Process Control",y:"quest",d:5,q:"Two process changes could both improve an upset, but making both simultaneously would hide which one worked. What is the better approach?",a:["Make controlled prioritized changes and observe response when conditions allow","Make both maximum changes immediately","Ignore the upset","Reset SCADA trends"],c:0}]},
{stage:"DRC BOSS",icon:"👑",questions:[
{t:"Safety",y:"quest",d:5,q:"Wet weather causes high influent flow, one critical pump is unavailable, clarifier blankets are rising, and a compliance parameter is trending toward its limit. What is the best FIRST priority?",a:["Increase WAS as much as possible","Protect personnel and compliance, verify critical equipment/capacity, stabilize the limiting process, then coordinate controlled response","Reset alarms until they clear","Wait for lab confirmation before acting"],c:1},
{t:"Process Control",y:"quest",d:5,q:"Operators report conflicting instrument readings during a developing process upset. What should the supervisor direct FIRST?",a:["Use whichever reading looks best","Change all controls to maximum","Verify critical readings with independent or field checks while maintaining safe stable operation","Use yesterday's settings"],c:2},
{t:"Safety",y:"quest",d:5,q:"A process upset has several possible causes and the plant remains within permit limits for now. What is the strongest supervisory response?",a:["Verify conditions, prioritize risk, preserve treatment capacity, make controlled changes, document actions, and monitor response","Make several aggressive changes at once","Silence alarms and continue normally","Focus only on the easiest equipment to inspect"],c:0}]}
];

const $=x=>document.getElementById(x), topics=[...new Set(bank.map(q=>q.t))];
let st=JSON.parse(localStorage.getItem("sludgequest")||"null")||{xp:0,streak:0,badges:[],stats:{}};st.battleWins=st.battleWins||0;st.battleLosses=st.battleLosses||0;st.battleTopics=st.battleTopics||{};st.seasonXp=st.seasonXp||0;st.seasonWins=st.seasonWins||0;st.seasonLosses=st.seasonLosses||0;st.seasonBossWins=st.seasonBossWins||0;st.seasonId=st.seasonId||"S1";st.operatorId=st.operatorId||("OP-"+Math.random().toString(36).slice(2,10)+Date.now().toString(36).slice(-4));st.operatorName=st.operatorName||"Operator";st.operatorPlant=st.operatorPlant||"Unassigned Plant";st.operatorGrade=st.operatorGrade||4;topics.forEach(t=>{st.stats[t]||={c:0,n:0};st.battleTopics[t]||={c:0,n:0}});
...
let mode,deck=[],i=0,current,answered=false,correct=0,soloTotal=10;
document.querySelectorAll("[data-mode]").forEach(b=>b.onclick=()=>startSolo(b.dataset.mode));
function startSolo(m){mode=m;i=0;correct=0;if(m==="quest"){deck=[];questStages.forEach((stage,si)=>stage.questions.forEach((q,qi)=>deck.push({...q,stage:stage.stage,stageIcon:stage.icon,stageIndex:si,stageQuestion:qi+1,stageTotal:stage.questions.length})));soloTotal=deck.length;show("solo");renderSolo();return}soloTotal=m==="boss"?5:10;let p=[...bank];if(m==="exam")p=p.filter(q=>q.y==="exam");if(m==="alarm")p=p.filter(q=>q.y==="scenario");if(m==="boss")p=p.filter(q=>q.y==="scenario"&&q.d>=4);while(p.length<soloTotal)p=[...p,...p];deck=shuffle(p).slice(0,soloTotal);show("solo");renderSolo()}
function renderSolo(){answered=false;$("soloNext").disabled=true;$("soloNext").textContent=(i===soloTotal-1?(mode==="boss"?"Finish Boss Shift":mode==="quest"?"Finish Plant Quest":"Finish Session"):"Next");current=deck[i];let surprise=mode!=="exam"&&mode!=="alarm"&&mode!=="quest"&&mode!=="boss"&&Math.random()<.15;if(surprise)current=shuffle(bank.filter(q=>q.y==="scenario"))[0];$("soloAlarm").classList.toggle("hidden",!surprise);$("soloMode").textContent=mode==="quest"?(current.stageIcon+" "+current.stage):(surprise?"BRAH… ALARM!":mode.toUpperCase());$("soloCount").textContent=mode==="quest"?((i+1)+"/"+soloTotal+" • Stage "+(current.stageIndex+1)+"/"+questStages.length):((i+1)+"/"+soloTotal);$("soloTopic").textContent=mode==="quest"?(current.t+" • Difficulty "+current.d):current.t;$("soloQ").textContent=current.q;$("soloFeedback").textContent=mode==="quest"?"Run da process — choose the BEST or FIRST operational answer.":"Choose the best answer.";$("soloA").innerHTML="";let order=current.a.map((_,x)=>x);if(mode==="quest"){let pattern=[2,0,3,1,1,3,0,2,3,0,2,1];let target=pattern[i%pattern.length],ci=order.indexOf(current.c);[order[ci],order[target]]=[order[target],order[ci]]}order.forEach((orig,j)=>{let b=document.createElement("button");b.className="answer";b.textContent=String.fromCharCode(65+j)+". "+current.a[orig];b.dataset.orig=String(orig);b.onclick=()=>answerSolo(orig);$("soloA").appendChild(b)})}
